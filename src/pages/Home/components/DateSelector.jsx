...
const DateSelector = () => {
    ...
    return (
        <div className='flex flex-row justify-between items-center  w-full shadow-none  md:shadow  md:shadow-slate-900 bg-slate-800 text-xs text-center font-bold md:rounded  mx-auto'>
