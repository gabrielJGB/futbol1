    ...
    <>
      {
        ...
        <div className={`flex flex-col  border-[0px] border-slate-700 md:py-3 py-2 `}>
          ...
          <div className='flex items-center justify-between gap-1 w-full px-0 rounded-md'>
            ...
            <div className='flex items-center justify-between w-full bg-slate-700 rounded-md '>
              <div></div>
              <div className={`${homeStat.label.toUpperCase() === "POSSESSION" ? "h-[15px]" : "h-[5px]"} bg-[#43e143] rounded-l`} style={{ width: (`${homeWidth.toFixed()}%`) }}></div>
            </div>

            <div className='relative flex items-center justify-between w-full bg-slate-700 rounded-md'>
