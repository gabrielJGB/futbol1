...
export const filterLeague = async  (leagueInfoResp,id)=>{
    ...
    const url2 = `https://site.web.api.espn.com/apis/site/v2/sports/soccer/scorepanel?league=${league.slug}&contentorigin=deportes&dates=${league.startDate}-${league.endDate}&lang=es&region=ar&limit=380`
